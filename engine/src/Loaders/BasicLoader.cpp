...
unsigned BasicLoader::loadFlatShade(std::vector<float> * dataBuffer, std::vector<unsigned short> * indexData,const  attrib_t & attrib, const std::vector<shape_t> & shapes)
{
	int vertIdx = 0;
...
unsigned BasicLoader::loadSmoothShade(std::vector<float> * dataBuffer, std::vector<unsigned short> * indexData,const  attrib_t & attrib, const std::vector<shape_t> & shapes)
{
	int vertIdx = 0;
	bool hasNors =  attrib.normals.size() > 0;
	bool hasTexCoords = attrib.texcoords.size() > 0;

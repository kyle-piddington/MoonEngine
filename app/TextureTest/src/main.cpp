...
int main(int argc, char ** argv)
{
    ...
    cameraObj->addComponent(scene->createComponent<ThirdPersonOrbitalController>(3.0));
    ...
    stringmap sky_textures(
            {{"tint", "tint"}, {"tint2", "tint2"}, {"sun", "sun"}, {"clouds1", "clouds1"}, {"clouds2", "clouds2"}});
